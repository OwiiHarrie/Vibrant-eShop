    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_variations', models.ManyToManyField(to='users.itemvariation')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.coupon')),
                ...
                ('payment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.payment')),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
        ...
        migrations.AddField(
            ...
            name='variation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.variation'),
        ),
